 ...
 */
@TableName(value ="cn_stock_fund_flow_industry")
@Data
public class CnStockFundFlowIndustry implements Serializable {
    /**
     * 
     */
    @TableId(value = "date")
    ...
    public boolean equals(Object that) {
        ...
        CnStockFundFlowIndustry other = (CnStockFundFlowIndustry) that;
